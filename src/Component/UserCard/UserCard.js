            ...
            <div className="card">
                <div className="card-header bg-white text-center border-0 " >
                    <div className="row justify-content-center " >
                        <div className="col"> <img className="align-self-center text-center rounded-circle outside img-fluid"
                         src="https://c1.klipartz.com/pngpicture/178/596/sticker-png-circle-silhouette-user-profile-avatar-black-line-blackandwhite-logo-rectangle.png" width="110" height="110"/> </div>
                    </div>
