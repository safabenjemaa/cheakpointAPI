...
useEffect(() => {
    ...
    style={{"marginRight":"30%","marginLeft":"15%","marginTop":"10%"}}>
    <div className="col-xl-6 col-md-12">
         <div className="card user-card-full">
         <div className="row m-l-0 m-r-0">
        <div className="col-sm-4 bg-c-lite-green user-profile">
          <div className="card-block text-center text-white">
                 <div className="m-b-25"> <img style={{width:50}} src="https://c1.klipartz.com/pngpicture/178/596/sticker-png-circle-silhouette-user-profile-avatar-black-line-blackandwhite-logo-rectangle.png"
